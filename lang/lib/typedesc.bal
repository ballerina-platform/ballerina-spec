...
# If not, then an error is returned. The `constructFrom` operation is recursively
# applied to each member of `v` using the type descriptor that the inherent type
# requires for that member.
# 
