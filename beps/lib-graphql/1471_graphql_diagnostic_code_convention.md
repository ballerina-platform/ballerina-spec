...
| `GRAPHQL_137` | `GRAPHQL_1205` | `FAILED_TO_ADD_ENTITY_RESOLVER` — **removed on delivery** of engine-native `_entities` ([GraphQL Compile-Time Dispatch BEP](1472_graphql_compile_time_dispatch.md) ([#1472](https://github.com/ballerina-platform/ballerina-spec/issues/1472))) |
